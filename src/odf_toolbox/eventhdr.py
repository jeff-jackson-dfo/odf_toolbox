...
class EventHeader(BaseHeader):
    ...
    def set_data_type(self, value: str, read_operation: bool = False) -> None:
        ...
        if not read_operation:
            self.logger.info(f"Event_Header.Data_Type changed from {self._data_type} to '{value}'")
    ...
    def set_event_number(self, value: str, read_operation: bool = False) -> None:
        ...
        value = value.strip("\' ")
        if not read_operation:
            self.logger.info(f"Event_Header.Event_Number changed from {self._event_number} to '{value}'")
    ...
    def set_event_qualifier1(self, value: str, read_operation: bool = False) -> None:
        ...
        value = value.strip("\' ")
        if not read_operation:
            self.logger.info(f"Event_Header.Event_Qualifier1 changed from {self._event_qualifier1} to '{value}'")
    ...
    def set_event_qualifier2(self, value: str, read_operation: bool = False) -> None:
        ...
        value = value.strip("\' ")
        if not read_operation:
            self.logger.info(f"Event_Header.Event_Qualifier2 changed from {self._event_qualifier2} to '{value}'")
    ...
    def set_creation_date(self, value: str, read_operation: bool = False) -> None:
        ...
        value = value.strip("\' ")
        if not read_operation:
            self.logger.info(f"Event_Header.Creation_Date changed from {self._creation_date} to '{value}'")
    ...
    def set_original_creation_date(self, value: str, read_operation: bool = False) -> None:
        ...
        value = value.strip("\' ")
        if not read_operation:
            self.logger.info(f"Event_Header.Original_Creation_Date changed from {self._original_creation_date} "
                                 f"to '{value}'")
    ...
    def set_start_date_time(self, value: str, read_operation: bool = False) -> None:
        ...
        value = value.strip("\' ")
        if not read_operation:
            self.logger.info(f"Event_Header.Start_Date_Time changed from {self._start_date_time} to '{value}'")
    ...
    def set_end_date_time(self, value: str, read_operation: bool = False) -> None:
        ...
        value = value.strip("\' ")
        if not read_operation:
            self.logger.info(f"Event_Header.End_Date_Time changed from {self._end_date_time} to '{value}'")
    ...
    def set_initial_latitude(self, value: float, read_operation: bool = False) -> None:
        ...
        if not read_operation:
            self.logger.info(f"Event_Header.Initial_Latitude changed from {self._initial_latitude} to {value}")
    ...
    def set_initial_longitude(self, value: float, read_operation: bool = False) -> None:
        ...
        assert isinstance(value, float), \
               f"Input value is not of type float: {value}"
        if not read_operation:
            self.logger.info(f"Event_Header.Initial_Longitude changed from {self._initial_longitude} to {value}")
    ...
    def set_end_latitude(self, value: float, read_operation: bool = False) -> None:
        ...
        assert isinstance(value, float), \
               f"Input value is not of type float: {value}"
        if not read_operation:
            self.logger.info(f"Event_Header.End_Latitude changed from {self._end_latitude} to {value}")
    ...
    def set_end_longitude(self, value: float, read_operation: bool = False) -> None:
        ...
        assert isinstance(value, float), \
               f"Input value is not of type float: {value}"
        if not read_operation:
            self.logger.info(f"Event_Header.End_Longitude changed from {self._end_longitude} to {value}")
    ...
    def set_min_depth(self, value: float, read_operation: bool = False) -> None:
        ...
        assert isinstance(value, float), \
               f"Input value is not of type float: {value}"
        if not read_operation:
            self.logger.info(f"Event_Header.Min_Depth changed from {self._min_depth} to {value}")
    ...
    def set_max_depth(self, value: float, read_operation: bool = False) -> None:
        ...
        assert isinstance(value, float), \
               f"Input value is not of type float: {value}"
        if not read_operation:
            self.logger.info(f"Event_Header.Max_Depth changed from {self._max_depth} to {value}")
    ...
    def set_sampling_interval(self, value: float, read_operation: bool = False) -> None:
        ...
        assert isinstance(value, float), \
               f"Input value is not of type float: {value}"
        if not read_operation:
            self.logger.info(f"Event_Header.Sampling_Interval changed from {self._sampling_interval} to {value}")
    ...
    def set_sounding(self, value: float, read_operation: bool = False) -> None:
        ...
        assert isinstance(value, float), \
               f"Input value is not of type float: {value}"
        if not read_operation:
            self.logger.info(f"Event_Header.Sounding changed from {self._sounding} to {value}")
    ...
    def set_depth_off_bottom(self, value: float, read_operation: bool = False) -> None:
        ...
        assert isinstance(value, float), \
               f"Input value is not of type float: {value}"
        if not read_operation:
            self.logger.info(f"Event_Header.Depth_Off_Bottom changed from {self._depth_off_bottom} to {value}")
    ...
    def set_station_name(self, value: str, read_operation: bool = False) -> None:
        ...
        value = value.strip("\' ")
        if not read_operation:
            self.logger.info(f"Event_Header.Station_Name changed from {self._station_name} to '{value}'")
    ...
    def set_set_number(self, value: str, read_operation: bool = False) -> None:
        ...
        value = value.strip("\' ")
        if not read_operation:
            self.logger.info(f"Event_Header.Set_Number changed from {self._set_number} to '{value}'")
    ...
    def set_event_comments(self, event_comment: str, comment_number: int = 0, read_operation: bool = False) -> None:
        ...
        if comment_number == 0 and number_of_comments >= 0:
            if not read_operation:
                self.logger.info(f"The following comment was added to Event_Header.Event_Comments: "
                                     f"'{event_comment}'")
            self._event_comments.append(f"'{event_comment}'")
        elif comment_number <= number_of_comments and number_of_comments > 0:
            if not read_operation:
                self.logger.info(f"Comment {comment_number} in Event_Header.Event_Comments was changed from "
